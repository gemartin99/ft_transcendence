...
function join_match() {
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=search&points=5');
...
function create_match() {
    ...
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=sala&points=5&sala=' + code);
...
function join_match_sala() {
    ...
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=sala&points=5&sala=' + document.getElementById("lobbyCode").value);
...
function join_IA() {
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=IA&points=11');
    socket.onopen = (event) => {
        console.log('WebSocket connection opened:', event);
...
async function reconnect() {
    ...
    if (socket == null && window.location.href == "http://crazy-pong.com/game/play/"){
        ...
        socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=reconnect&points=5');
        socket.onopen = (event) => {
            console.log('WebSocket connection opened:', event);
...
function obs_match() {
    ...
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=obs&sala=' + document.getElementById("lobbYCode").value);
...
async function one_vs_one_without_shirt(e) {
        ...
        socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=1vs1&points=' + points + '&p1=' + p1 + '&p2=' + p2);
...
function gameTournament(id, points) {
    ...
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=sala&points=' + points + '&sala=' + id);
...
function gameTournamentIA(id, points) {
    ...
    socket = new WebSocket('wss://'+ domain +':8000/wss/game/?user='+ getCookie('jwttoken') +'&mode=salaIA&points=' + points + '&sala=' + id);
