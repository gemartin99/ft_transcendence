...
from .views import get_home_page, get_login_page, get_login_form_page, get_login42_form_page, change_view, get_register_new_account_page, create_account, do_login, show_online, logout, get_profile_page, get_profile_settings_page
...
urlpatterns = [
     ...
     path('profile/settings/', get_profile_settings_page, name='get_profile_settings_page'),
